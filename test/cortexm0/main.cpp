...
int main(int argc, char *argv[]){
    ...
    jcpu::jcpu *cortex_m0 = jcpu::jcpu::create("arm", "cortexm0");
    dummy_mem mem(argv[1], *cortex_m0);
    cortex_m0->set_ext_interface(&mem);
    cortex_m0->reset(true);
    cortex_m0->reset(false);
    cortex_m0->run(cortex_m0->RUN_OPTION_NORMAL);
    //cortex_m0->run(cortex_m0->RUN_OPTION_WATI_GDB);
